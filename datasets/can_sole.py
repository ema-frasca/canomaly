...
class CanSOLE(CanomalyDataset):
    ...
    def __init__(self, args: Namespace):
        ...
        y_train = y_train[x_train['num_richieste'] != 0]
        x_train = x_train[x_train['num_richieste'] != 0]
        y_test = y_test[x_test['num_richieste'] != 0]
        x_test = x_test[x_test['num_richieste'] != 0]
    ...
    def _get_joint_dataset(self):
        labels = [0] #[cl for cl in range(self.N_CLASSES - self.classes_per_task)]
