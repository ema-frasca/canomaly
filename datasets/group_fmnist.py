...
class GroupFMNIST(CanomalyDataset):
    NAME = 'group-fmnist'
    INPUT_SHAPE = (1, 28, 28)
    N_CLASSES = 10
    N_GROUPS = 4
    ...
    ## Classes:
    ##      0: 0 - 2 - 4 - 6    -> upper body and dresses
    ##      1: 1 - 3            -> trousers
    ##      3: 5 - 7 - 9        -> shoes
    ##      4: 8                -> bags
    ...
    def add_dataset_args(parser: ArgumentParser):
        ...
        parser.add_argument('--ano_group', type=int, choices=[i for i in range(GroupFMNIST.N_GROUPS)],
                            default=GroupFMNIST.N_GROUPS-1, help='Group-class that will stay as anomaly.')
    ...
    def __init__(self, args: Namespace):
        super(GroupFMNIST, self).__init__(args)
