...
parser = ArgumentParser(description='srv-sbatch for canomaly', allow_abbrev=False)
...
if args.one_node:
    sbacci = [f'/homes/{args.user_name}/.conda/envs/{args.envname}/bin/python main.py {x} ;'
